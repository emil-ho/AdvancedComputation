...
//        			  }
        			  ...
        			  //This loop is just to consume CPU and essay a main program
        			  //remove it if using this class to run the simulation
        			  for (int consumeCPU=0; consumeCPU<100000; consumeCPU++) {
        				  double a= Math.sin(consumeCPU*18.0);
        			  }
